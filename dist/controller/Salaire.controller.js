...
exports.SalaireController = void 0;
const mongodb_1 = require("mongodb");
const datasource_1 = __importDefault(require("../datasource"));
const decorator_1 = require("../decorator");
const model_1 = require("../model");
let SalaireController = class SalaireController {
    getAll(res, option) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                res.json(yield model_1.Salaire.getAll(client.currentDb, option));
            }
            catch (error) {
    ...
    getDepense(res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                client = yield (0, datasource_1.default)();
                res.json(yield model_1.Salaire.getAll1(client.currentDb));
            }
            catch (error) {
                res.status(500).send(error.message);
            }
    ...
    getById(res, id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const respon = (yield model_1.Salaire.getById(dbClient.currentDb, id))[0];
    ...
    delete(res, id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                client = yield (0, datasource_1.default)();
                const voiture = new model_1.Salaire();
                voiture.id = id;
...
], SalaireController.prototype, "getAll", null);
__decorate([
    (0, decorator_1.Get)("/depense"),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], SalaireController.prototype, "getDepense", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], SalaireController.prototype, "getById", null);
__decorate([
    (0, decorator_1.Post)(""),
    __param(1, decorator_1.RequestBody),
    __param(1, decorator_1.cast),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, model_1.Salaire]),
    __metadata("design:returntype", Promise)
], SalaireController.prototype, "save", null);
__decorate([
    (0, decorator_1.Put)(""),
    __param(1, decorator_1.cast),
    __param(1, decorator_1.RequestBody),
    ...
    __metadata("design:paramtypes", [Object, model_1.Salaire]),
    __metadata("design:returntype", Promise)
], SalaireController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], SalaireController.prototype, "delete", null);
SalaireController = __decorate([
    (0, decorator_1.RestController)("/api/salaire")
], SalaireController);
exports.SalaireController = SalaireController;
