...
exports.MarquePieceModelVoiture = void 0;
...
class MarquePieceModelVoiture extends Entity_1.Entity {
    save(db) {
    ...
    static getAll(db, pipeline = new Array()) {
        const collection = db.collection("marquePieceModelVoiture");
        return collection.aggregate([...relation_1.modelVoiture, ...relation_1.relationPiece, ...pipeline]).toArray().then((m) => (0, util_1.assignArray)(MarquePieceModelVoiture, m));
    }
    delete(db) {
        const collection = db.collection("marquePieceModelVoiture");
    ...
    static getById(db, id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield MarquePieceModelVoiture.getAll(db, [
                {
                    $match: {
...
], MarquePieceModelVoiture.prototype, "marquePiece", void 0);
__decorate([
    decorator_1.cast,
    __metadata("design:type", ModelVoiture_1.ModelVoiture)
], MarquePieceModelVoiture.prototype, "modelVoiture", void 0);
exports.MarquePieceModelVoiture = MarquePieceModelVoiture;
