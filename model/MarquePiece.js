...
exports.MarquePiece = void 0;
const mongodb_1 = require("mongodb");
const decorator_1 = require("../decorator");
const util_1 = require("../util");
const Entity_1 = require("./Entity");
const relation_1 = require("../relation");
class MarquePiece extends Entity_1.Entity {
    save(db) {
    ...
    static getAll(db, pipeline = new Array()) {
        const collection = db.collection("marquePiece");
        return collection.aggregate([...relation_1.modelVoitureMarquePieceRelation, ...pipeline]).toArray().then(m => (0, util_1.assignArray)(MarquePiece, m));
    }
    update(db) {
        const collection = db.collection("marquePiece");
    ...
    static getById(db, id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield MarquePiece.getAll(db, [
                {
                    $match: {
...
], MarquePiece.prototype, "modelVoiture", void 0);
exports.MarquePiece = MarquePiece;
