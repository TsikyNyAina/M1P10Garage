...
let ReparationController = class ReparationController {
    getAll(res, option) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                res.json(yield model_1.Reparation.getAll(client.currentDb, option));
            }
            catch (error) {
    ...
    getById(res, id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const respon = (yield model_1.Reparation.getById(dbClient.currentDb, id))[0];
    ...
    save(res, reparation) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                client = yield (0, datasource_1.default)();
                res.json(yield reparation.save(client.currentDb));
            }
            catch (error) {
    ...
    update(res, reparation) {
        return __awaiter(this, void 0, void 0, function* () {
            let client;
            try {
                client = yield (0, datasource_1.default)();
                res.json(yield reparation.update(client.currentDb));
            }
            catch (error) {
                res.status(500).json(error.message || error);
            }
    ...
    delete(res, id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                client = yield (0, datasource_1.default)();
                const reparation = new model_1.Reparation();
                reparation.id = id;
                res.status(200).json(yield reparation.delete(client.currentDb));
            }
            catch (error) {
                res.status(500).json(error.message || error);
            }
...
], ReparationController.prototype, "getAll", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], ReparationController.prototype, "getById", null);
__decorate([
    (0, decorator_1.Post)(""),
    __param(1, decorator_1.RequestBody),
    __param(1, decorator_1.cast),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, model_1.Reparation]),
    __metadata("design:returntype", Promise)
], ReparationController.prototype, "save", null);
__decorate([
    (0, decorator_1.Put)(""),
    __param(1, decorator_1.cast),
    __param(1, decorator_1.RequestBody),
    ...
    __metadata("design:paramtypes", [Object, model_1.Reparation]),
    __metadata("design:returntype", Promise)
], ReparationController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ReparationController.prototype, "delete", null);
ReparationController = __decorate([
    (0, decorator_1.RestController)("/api/reparation")
