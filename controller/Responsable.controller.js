...
let ResponsableController = class ResponsableController {
    getAll(res, option) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                res.json(yield model_1.Responsable.getAll(dbClient.currentDb, option));
            }
            catch (error) {
    ...
    getOne(res, id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                dbClient = yield (0, datasource_1.default)();
                const respon = (yield model_1.Responsable.getById(dbClient.currentDb, id))[0];
    ...
    delete(res, id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                dbClient = yield (0, datasource_1.default)();
                const client = new model_1.Responsable();
                client.id = id;
...
], ResponsableController.prototype, "getAll", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], ResponsableController.prototype, "getOne", null);
__decorate([
    (0, decorator_1.Post)(""),
    __param(1, decorator_1.RequestBody),
    __param(1, decorator_1.cast),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, model_1.Responsable]),
    __metadata("design:returntype", Promise)
], ResponsableController.prototype, "save", null);
__decorate([
    (0, decorator_1.Put)(""),
    __param(1, decorator_1.cast),
    __param(1, decorator_1.RequestBody),
    ...
    __metadata("design:paramtypes", [Object, model_1.Responsable]),
    __metadata("design:returntype", Promise)
], ResponsableController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ResponsableController.prototype, "delete", null);
ResponsableController = __decorate([
    (0, decorator_1.RestController)("/api/responsable")
