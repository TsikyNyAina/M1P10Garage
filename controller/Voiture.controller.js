...
let VoitureController = class VoitureController {
    getAll(res, option) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                res.json(yield model_1.Voiture.getAll(client.currentDb, option));
            }
            catch (error) {
    ...
    getById(res, id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const respon = (yield model_1.Voiture.getById(dbClient.currentDb, id))[0];
    ...
    delete(res, id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                client = yield (0, datasource_1.default)();
                const voiture = new model_1.Voiture();
                voiture.id = id;
...
], VoitureController.prototype, "getAll", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], VoitureController.prototype, "getById", null);
__decorate([
    (0, decorator_1.Post)(""),
    __param(1, decorator_1.RequestBody),
    __param(1, decorator_1.cast),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, model_1.Voiture]),
    __metadata("design:returntype", Promise)
], VoitureController.prototype, "save", null);
__decorate([
    (0, decorator_1.Put)(""),
    __param(1, decorator_1.cast),
    __param(1, decorator_1.RequestBody),
    ...
    __metadata("design:paramtypes", [Object, model_1.Voiture]),
    __metadata("design:returntype", Promise)
], VoitureController.prototype, "update", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], VoitureController.prototype, "delete", null);
VoitureController = __decorate([
    (0, decorator_1.RestController)("/api/voiture")
], VoitureController);
